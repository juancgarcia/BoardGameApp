...
(function(){
	...
	appNamespace.mixin = function(/*Object*/ obj, /*Object...*/ props){
		if(!obj){ obj = {}; }
	...
	appNamespace.combine = function(/*Object*/ obj, /*Object...*/ props) {
		var newObj = {};
	...
	*/
	appNamespace.locale = function(/*Object*/ map) {
	...
	*/
	appNamespace.os = function(/*Object*/ map) {
		var def = map.def||null; //default function or value
...
Ti.include(
	'/boardGameApp/ui/ui.js'//,
	//'/boardGameApp/model/model.js',
	//'/boardGameApp/config/config.js'
);